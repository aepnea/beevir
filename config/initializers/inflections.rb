...
# locales as you wish. All of these examples are active by default:
 ActiveSupport::Inflector.inflections do |inflect|
	...
	inflect.irregular 'remuneracion','remuneraciones'
	inflect.irregular 'empleado','empleados'
	inflect.irregular 'estado','estados'
	inflect.irregular 'deber','deberes'
	inflect.irregular 'haber','haberes'
	inflect.irregular 'tipo_remuneracion','tipo_remuneraciones'
	inflect.irregular 'tipo_valor','tipo_valores'
 end
